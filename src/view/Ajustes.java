...
public class Ajustes extends JFrame {
    ...
    public Ajustes(boolean oscuro) {
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] {"Español", "Portugués", "Inglés", "Ruso", "Alemán", "Sueco"}));
    ...
    private void cargarPreferenciaTema() {
        ...
        // Obtener la preferencia del tema guardada, con un valor predeterminado de falso (tema claro)
    ...
    // Sobreescribe el método setVisible para guardar la preferencia del tema al cerrar la ventana
    @Override
